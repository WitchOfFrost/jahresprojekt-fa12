import pygame, sys, re#, GameflowV2

#SETUP
Path = "C:\\Users\\Jasper\\Desktop\\assets\\"
MusicVolume = 0.5
SoundVolume = 0.8
LoggedInUsername = ''
LoggedIn = False
...
def PlayClickSound():
    ClickSound = pygame.mixer.Sound(Path + "buttonClick.mp3")
...
def RunGame(Game, Difficulty):
    ...
    #GameFlow = GameflowV2.Spielesammlung(Game, Difficulty)
...
def OpenLeaderboard():
    global LoggedIn
    HasPrinted = False
    UsernameList = ['A','B','C','D','E','F','G','H','I','J','K','L']
...
def OpenSignIn():
    ...
    while True:
        ...
        if ShowFailedLogin:
            LoggedInBottomText = GetFont(10).render("Username is already in use!", True, ButtonTextColorBlack)
